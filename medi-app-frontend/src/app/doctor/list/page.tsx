"use client" //por padrão o next renderiza no lado do servidor, essa linha informa ao next q essa página deve ser tratada como um componente do client side, renderizado no navegador
    ...
    useEffect(() => {
        fetch('http://127.0.0.1:3001/doctors', {
            ...
            headers: {
                ...
                'Authorization': sessionStorage.getItem("token") || '' //o Authorization do header não pode ser null, então passamos q ele tenha o token (caminho feliz) ou 'tenha um vazio' (o que resulta em negação desse fetch), mas não null
            },
